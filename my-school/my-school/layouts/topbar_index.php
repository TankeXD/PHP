...
$nombre_cliente = isset($_SESSION['nombre']) ? $_SESSION['nombre'] : "Nombre";
$apellido = isset($_SESSION['apellido']) ? $_SESSION['apellido'] : "Apellido";
?>




<header id="page-topbar" style="background: linear-gradient(45deg, #6ab1d7, #33d9b2) !important;">
    <div class="layout-width">
        <div class="navbar-header">
            ...
            <div class="d-flex align-items-center">
                <!--Perfil de usuario-->
                <div class="dropdown ms-sm-3 header-item topbar-user"  style="background-color:rgba(95, 231, 255, 1.50)!important;;">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text" style="font-size: 18px; color: rgba(255, 255, 255, 1);">Apoderad@</span>
                                <span class="d-none d-xl-block ms-1 fs-12 user-name-sub-text" style="font-size: 100px; color: rgba(74, 76, 77, 1);"><?php echo $nombre_cliente;?> <?php echo $apellido;?></span>
                            </span>
                        </span>
                    </button>
